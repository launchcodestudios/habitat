...
gulp.task('js-build-bundle', function () {
	return gulp.src([
			...
			'build/js/habitat.min.js',
		])
		.pipe(concat('habitat-bundle.min.js'))
...
gulp.task('css-build-full-bundle', function () {
	return gulp.src([
			...
			'build/css/habitat.min.css',
		])
		.pipe(concat('habitat-bundle.min.css'))
...
gulp.task('css-build-design-bundle', function () {
	return gulp.src([
		...
		.pipe(concat('habitat-design-bundle.min.css'))
		.pipe(gulp.dest('build/css'));
});
